...
private:
    ...
    QButtonGroup* group_radio_btn_;
    QRadioButton* radio_option1_;
    QRadioButton* radio_option2_;
    QRadioButton* radio_option3_;
    QRadioButton* radio_option4_;
    ...
    QVBoxLayout* lyt_radio_;
    QHBoxLayout* lyt_radio_combo_;
};
