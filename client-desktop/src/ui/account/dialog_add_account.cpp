...
void DialogAddAccount::setup_ui(){
    ...
    QFormLayout* lyt_form_key = new QFormLayout;
    QHBoxLayout* lyt_key_and_button = new QHBoxLayout;
    lyt_main->addSpacing(30);
    lyt_main->addLayout(lyt_grid);
    lyt_main->addLayout(lyt_key_and_button);
    lyt_main->addSpacing(30);
    ...
    lyt_form_key->addRow("密钥", this->edit_main_key_);
    ...
    lyt_key_and_button->addLayout(lyt_form_key);
    lyt_key_and_button->addWidget(this->btn_refresh_);
    lyt_key_and_button->addWidget(this->btn_clear_);
    lyt_key_and_button->addWidget(this->btn_submit_);
